...
- (void)viewDidLoad
{
    ...
    // 2.加载授权页面(新浪提供的登录页面)
    NSURL *url = [NSURL URLWithString:@"https://api.weibo.com/oauth2/authorize?client_id=4116491016&redirect_uri=https://www.baidu.com"];
...
- (void)accessTokenWithCode:(NSString *)code
{
    ...
    params[@"client_id"] = @"4116491016";
    params[@"client_secret"] = @"706c50f1f5e609cbc717aeea57d91580";
